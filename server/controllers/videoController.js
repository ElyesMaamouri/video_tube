...
export const updateVideo = async (req, res, next) => {
    try {
        ...
        if (req.user.id === video.userId) {
            ...
            return next(createError(403, 'You can upadte only your video'))
        }
...
export const deleteVideo = async (req, res, next) => {
    try {
        ...
        if (req.user.id === video.userId) {
            ...
            return next(createError(403, 'you can only deleted your video'))
        }
...
export const addViewVideo = async (req, res, next) => {
    try {
...
export const getByTag = async (req, res, next) => {
  ...
  export const getByTilte = async (req, res, next) => {
